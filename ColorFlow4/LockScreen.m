/*
If you're a developer, you can add ColorFlow 4 support to your Lock Screen tweak.

This API is consistent across ColorFlow 1 - ColorFlow 4.

ColorFlow 4 will post notifications when the lockscreen is colored/reverted:
