...
Say you wanted to add ColorFlow 3 support to Control Center. This would not be hard to do - the
...
Given that you're using an MPUNowPlayingController, here's example code to add ColorFlow 3 to your
SpringBoard tweak.
*/
